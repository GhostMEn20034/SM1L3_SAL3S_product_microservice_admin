...
from src.apps.variaton_themes.schemes import VariationThemeFilter
...
class BaseAttrs(BaseModel):
    ...
    # Determines the amount of products_base in stock
    stock: conint(ge=0)
...
class VariationThemeInProduct(BaseModel):
    ...
    name: constr(min_length=1) = Field(...)
    # Options that determine difference between products_base
...
class Product(ProductVariation):
    ...
    # Determines whether product is parent of some products_base
    parent: bool
