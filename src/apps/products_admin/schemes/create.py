...
from src.apps.categories_admin.schemes import CategoryForChoices
...
from src.apps.products.schemes.base import Attr, BaseAttrs, ProductVariation, VariationThemeInProduct
