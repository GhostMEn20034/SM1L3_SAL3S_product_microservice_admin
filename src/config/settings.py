...
# Microservice Keys
USER_MICROSERVICE_KEY = os.getenv("USER_MICROSERVICE_KEY")
JWT_SIGNING_KEY = os.getenv("JWT_SIGNING_KEY")

VERIFY_USERS_REQUESTS = bool(int(os.getenv("VERIFY_USERS_REQUESTS", 0)))

# Microservice Base URLs
USER_MICROSERVICE_BASE_URL = os.getenv("USER_MICROSERVICE_BASE_URL")
