...
from src.apps.deals.schemes.base import DealBase, ParentDealBase
from src.apps.deals.schemes.create import CreateDealSchema
from src.apps.deals.schemes.update import UpdatedDeal, UpdateDealSchema, UpdatedParentDeal
