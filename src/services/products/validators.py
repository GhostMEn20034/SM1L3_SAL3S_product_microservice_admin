from src.apps.products.schemes.create import CreateProduct
from src.apps.products.schemes.update import UpdateProduct, ExtraProductDataUpdate
from src.services.products.product_validation_helpers import (
...
from src.apps.products.utils import AttrsHandler
