...
from src.events_admin.schemes.get import EventListResponse, EventsDetailResponse
from .schemes.create import CreateEvent
from .schemes.update import UpdateEvent
from .service import EventAdminService
from src.dependencies import get_event_admin_service
...
async def get_event_list(page: int = fastapi.Query(1, ge=1, ),
                         ...
                         service: EventAdminService = fastapi.Depends(get_event_admin_service)):
